...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_useHashAutoLink":false,
      "vtp_autoLinkDomains":"secure.avangate.com, secure.2checkout.com, creative-tim.com, www.creative-tim.com",
      "vtp_decorateFormsAutoLink":false,
      "vtp_enableLinkId":false,
  ...
  "predicates":[{
      ...
      "function":"_cn",
      "arg0":["macro",7],
      "arg1":"\/tailwind-starter-kit"
    },{
      "function":"_cn",
      "arg0":["macro",7],
      "arg1":"material-tailwind"
    },{
      "function":"_cn",
      "arg0":["macro",7],
      "arg1":"marketplace"
  ...
  "rules":[
    ...
    [["if",37,38],["add",24]],
    [["if",0,3,39],["add",25,26]],
    [["if",1],["unless",3,40,41,42,43,44,45,46,47],["add",49]],
    [["if",1,3],["add",0]],
    [["if",1,3,8],["add",50]],
    [["if",1,3,48],["add",51]],
    [["if",1,3,49],["add",52]],
    [["if",3,4,8,10,50,51],["add",53]],
    [["if",3,39,52],["add",55]],
    [["if",8,38,53],["add",56]]]
},
...
var Sg=[L.C,L.F],Tg=function(a){var b=a[L.md];b&&Cf(40);var c=a[L.Fe];c&&Cf(41);for(var d=Na(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==L.md&&f!==L.Fe)if(-1<Pa(Sg,f)){var g=f,h=a[f],l=d[e];xg().set(g,h,l,"RU","RU-STA",c)}else{}},Ug=function(a,
...
g)};h.Nf=um();vm(b,h.Ra);var l=he(h);e&&(l=wm(l));var m=rm(l,h);"gtm.js"!==c&&"gtm.sync"!==c||El(me.I);switch(c){case "gtm.init":m&&Cf(20)}return xm(l,m)};function tm(a){return function(b){dm&&(Ib(b)||gm(a,"input",b))}}
...
W.h.e=["google"],function(){(function(a){W.__e=a;W.__e.i="e";W.__e.m=!0;W.__e.priorityOverride=0})(function(a){var b=String(ri(a.vtp_gtmEventId,"event"));a.vtp_gtmCachedValues&&(b=String(a.vtp_gtmCachedValues.event));return b})}();
...
Oa.push(Ka.jb)}return Oa},fb=function(Wa,Oa,Ka){if(!Eb(Oa))return!1;for(var gb=bb(Object(Oa),Ka,[]),pd=0;gb&&pd<gb.length;pd++)D(Wa,gb[pd]);return!!gb&&0<gb.length},Z;if(q.vtp_useEcommerceDataLayer){var md=!1;if(q.vtp_useGA4SchemaForEcommerce){q.vtp_gtmCachedValues&&(Z=q.vtp_gtmCachedValues.eventModel);Z=Z||ri(q.vtp_gtmEventId,"eventModel");md=!!Z}md||(Z=qs("ecommerce",1))}else q.vtp_ecommerceMacroData&&(Z=q.vtp_ecommerceMacroData.ecommerce,!Z&&q.vtp_useGA4SchemaForEcommerce&&(Z=q.vtp_ecommerceMacroData));if(!Eb(Z))return;Z=Object(Z);if(q.vtp_useGA4SchemaForEcommerce){Z=
J(Z);Z.currencyCode=Z.currencyCode||Z.currency;var vb;q.vtp_gtmCachedValues&&(vb=q.vtp_gtmCachedValues.event);vb=vb||String(ri(q.vtp_gtmEventId,"event"));if("view_item_list"===vb&&!Z.impressions&&Z.items)Z.impressions=eb(Z.items);else if("view_promotion"===vb&&!Z.promoView&&Z.items)Z.promoView={},Z.promoView.promotions=eb(Z.items);else if("select_promotion"===vb&&!Z.promoClick)Z.items&&(Z.promoClick=
...
0})(function(t){var u=t.vtp_gtmEventId,v=t.vtp_defaultValue,x=t.vtp_varType,z;t.vtp_gtmCachedValues&&(z=t.vtp_gtmCachedValues.gtm);switch(x){case "TAG_NAME":var w=a(z,u,"element");return w&&w.tagName||v;case "TEXT":return b(z,u,x,pg)||v;case "URL":var y;a:{var B=String(a(z,u,"elementUrl")||v||""),C=th(B),E=String(t.vtp_component||"URL");switch(E){case "URL":y=B;break a;case "IS_OUTBOUND":y=
